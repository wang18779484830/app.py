...
if st.button("Calculate"):
    ...
    scores = [python, excel, data]
    labels = ["Python", "Excel", "DL"]
    chart_data = {"Subject": labels, "Score": scores}
    st.bar_chart(chart_data, x="Subject", y="Score")

    st.subheader("Score Trend (Line)")
    st.line_chart(chart_data, x="Subject", y="Score")
